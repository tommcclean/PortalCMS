/*! * Bootstrap Confirmation v1.0.5 * https://github.com/tavicu/bs-confirmation */ +function (a) {
    "use strict"; var b = !1, c = function (c, d) {
        var e = this; init("confirmation", c, d),
    ...
    c.VERSION = "1.0.5", c.DEFAULTS = a.extend({},
        ...
        c.prototype.setContent = function () {
            var b = this, c = tip(),
                ...
                g = options; e.addClass(getBtnOkClass()).html(getBtnOkLabel()).prepend(a("<i></i>").addClass(getBtnOkIcon()),
                    " ").attr("href", getHref()).attr("target", getTarget()).off("click").on("click", function (a) {
                        g.onConfirm(a, b.$element),
                            "submit" == b.$element.attr("type") && b.$element.closest("form").first().submit(),
                            b.hide(),
                            b.inState.click = !1
                    }),
                    f.addClass(getBtnCancelClass()).html(getBtnCancelLabel()).prepend(a("<i></i>").addClass(getBtnCancelIcon()),
                        " ").off("click").on("click", function (a) {
                            g.onCancel(a, b.$element),
                                b.hide(),
                                b.inState.click = !1
                        }),
                    c.find(".popover-title")[options.html ? "html" : "text"](d),
                    c.removeClass("fade top bottom left right in"),
                    c.find(".popover-title").html() || c.find(".popover-title").hide()
        },
        c.prototype.getBtnOkClass = function () { var a = $element, b = options; return a.attr("data-btnOkClass") || ("function" == typeof b.btnOkClass ? b.btnOkClass.call(this, a[0]) : b.btnOkClass) },
        c.prototype.getBtnOkLabel = function () { var a = $element, b = options; return a.attr("data-btnOkLabel") || ("function" == typeof b.btnOkLabel ? b.btnOkLabel.call(this, a[0]) : b.btnOkLabel) },
        c.prototype.getBtnOkIcon = function () { var a = $element, b = options; return a.attr("data-btnOkIcon") || ("function" == typeof b.btnOkIcon ? b.btnOkIcon.call(this, a[0]) : b.btnOkIcon) },
        c.prototype.getBtnCancelClass = function () { var a = $element, b = options; return a.attr("data-btnCancelClass") || ("function" == typeof b.btnCancelClass ? b.btnCancelClass.call(this, a[0]) : b.btnCancelClass) },
        c.prototype.getBtnCancelLabel = function () { var a = $element, b = options; return a.attr("data-btnCancelLabel") || ("function" == typeof b.btnCancelLabel ? b.btnCancelLabel.call(this, a[0]) : b.btnCancelLabel) },
        c.prototype.getBtnCancelIcon = function () { var a = $element, b = options; return a.attr("data-btnCancelIcon") || ("function" == typeof b.btnCancelIcon ? b.btnCancelIcon.call(this, a[0]) : b.btnCancelIcon) },
        c.prototype.getHref = function () { var a = $element, b = options; return a.attr("data-href") || ("function" == typeof b.href ? b.href.call(this, a[0]) : b.href) },
        c.prototype.getTarget = function () { var a = $element, b = options; return a.attr("data-target") || ("function" == typeof b.target ? b.target.call(this, a[0]) : b.target) },
        c.prototype.isPopout = function () {
            var a, b = $element, c = options; return a = b.attr("data-popout") || ("function" == typeof c.popout ? c.popout.call(this, b[0]) : c.popout),
                "false" == a && (a = !1),
                a
        };
    var d = a.fn.confirmation; a.fn.confirmation = function (b) {
        var d = this; return each(function () {
            var e = a(this),
