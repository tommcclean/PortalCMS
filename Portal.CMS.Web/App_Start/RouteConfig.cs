        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            foreach (var page in pageList)
            {
                ...
                if (string.IsNullOrWhiteSpace(page.PageArea) && page.PageController.Equals("Home", System.StringComparison.OrdinalIgnoreCase) && page.PageAction.Equals("Index", System.StringComparison.OrdinalIgnoreCase))
                    routes.MapRoute($"PageBuilder_{page.PageId}_Base", "", new { area = "PageBuilder", controller = "Build", action = "Index", pageId = page.PageId });
                ...
                if (page.PageAction.Equals("Index", System.StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    routes.MapRoute($"PageBuilder_{page.PageId}_Index", targetRoute, new { area = "PageBuilder", controller = "Build", action = "Index", pageId = page.PageId });
                }
                ...
                routes.MapRoute($"PageBuilder_{page.PageId}", targetRoute, new { area = "PageBuilder", controller = "Build", action = "Index", pageId = page.PageId });
            }
