        ...
        public static void Seed(PortalEntityModel context)
        {
            if (!context.Pages.Any())
            {
                ...
                context.Pages.Add(new Page
                {
                    ...
                    PageSections = new List<PageSection>
                    {
                        new PageSection { PageSectionBody = "<section id=\"section-5\" class=\"header background-parallax height-tall\"><div class=\"overlay-medium\"></div><div id=\"component-100916160418-5\" class=\"vertical-alignment component-container\"><h1 id=\"title-5\" data-section=\"5\">Server Error</h1><p id=\"subtitle-5\">Sorry but something went wrong. We have logged the problem and will look into it.</p><a id=\"component-1473519891239-5\" onclick=\"history.go(-1);\"  class=\"btn square\" target=\"\">Back</a></div></section>" },
                    }
                });
                ...
                context.Pages.Add(new Entities.PageBuilder.Page
                {
                    ...
                    PageSections = new List<PageSection>
                    {
                        new PageSection { PageSectionBody = "<section id=\"section-6\" class=\"header background-parallax height-tall\"><div class=\"overlay-medium\"></div><div id=\"component-100916160418-6\" class=\"vertical-alignment component-container\"><h1 id=\"title-6\" data-section=\"6\">Page Not Found</h1><p id=\"subtitle-6\">Sorry but the page you just tried to access is not there. You might be able to find it via the Home Page.</p><a id=\"component-1473519891239-6\" href=\"~/\"  class=\"btn square\" target=\"\">Back</a></div></section>" },
                    }
                });
            }
        }
