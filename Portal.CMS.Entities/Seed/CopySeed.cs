    ...
    public static class CopySeed
    {
        public static void Seed(PortalEntityModel context)
        {
            ...
            if (!copyList.Any(x => x.CopyName == "Sign In Message"))
                newCopyList.Add(new Copy { CopyName = "Sign In Message", CopyBody = "<p>Please enter your sign in details below.</p>", DateAdded = DateTime.Now, DateUpdated = DateTime.Now });
