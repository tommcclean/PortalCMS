    ...
    public static class PageComponentTypeSeed
    {
        public static void Seed(PortalEntityModel context)
        {
            ...
            if (!componentList.Any(x => x.PageComponentTypeName == "Flex"))
                newComponents.Add(new PageComponentType { PageComponentTypeName = "Flex", PageComponentTypeCategory = PageComponentTypeCategory.Image, PageComponentTypeDescription = "Image That Flexes To Native Size", PageComponentBody = "<img id=\"component-<componentStamp>-<sectionId>\" alt=\"Flexible Image\" class=\"image image-auto\" src=\"/Areas/Builder/Content/Images/Sample/small-sample-1.jpg\">" });
