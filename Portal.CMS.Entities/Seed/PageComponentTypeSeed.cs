...
namespace Portal.CMS.Entities.Seed
{
    public static class PageComponentTypeSeed
    {
        public static void Seed(PortalEntityModel context)
        {
            ...
            newComponents.Add(new PageComponentType { PageComponentTypeName = "Avatar", PageComponentTypeCategory = PageComponentTypeCategory.Image, PageComponentBody = "<div id=\"component-<componentStamp>-<sectionId>\" class=\"image image-circle\" style=\"background-image: url('/Areas/PageBuilder/Content/Images/Sample/Sample-4.jpg');\"></div>" });
            newComponents.Add(new PageComponentType { PageComponentTypeName = "Square", PageComponentTypeCategory = PageComponentTypeCategory.Image, PageComponentBody = "<div id=\"component-<componentStamp>-<sectionId>\" class=\"image image-square\" style=\"background-image: url('/Areas/PageBuilder/Content/Images/Sample/Sample-5.jpg');\"></div>" });
            ...
            newComponents.Add(new PageComponentType { PageComponentTypeName = "Image", PageComponentTypeCategory = PageComponentTypeCategory.Image, PageComponentBody = "<div id=\"component-<componentStamp>-<sectionId>\" class=\"image image-standard\" style=\"background-image: url('/Areas/PageBuilder/Content/Images/Sample/Sample-1.jpg');\"></div>" });
            newComponents.Add(new PageComponentType { PageComponentTypeName = "Flex", PageComponentTypeCategory = PageComponentTypeCategory.Image, PageComponentBody = "<img id=\"component-<componentStamp>-<sectionId>\" alt=\"Flexible Image\" class=\"image image-auto\" src=\"/Areas/PageBuilder/Content/Images/Sample/small-sample-1.jpg\">" });
            newComponents.Add(new PageComponentType { PageComponentTypeName = "Embed Video", PageComponentTypeCategory = PageComponentTypeCategory.Image, PageComponentBody = "<div id=\"element-1-<componentStamp>-<sectionId>\" class=\"video widget-wrapper embed-responsive embed-responsive-16by9\"><iframe class=\"embed-responsive-item\" width=\"640\" height=\"480\" src=\"https://www.youtube.com/embed/C0DPdy98e4c\" frameborder=\"0\" allowfullscreen></iframe></div>" });
